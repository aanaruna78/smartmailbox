            ...
            {viewMode === 'edit' ? (
              ...
              <Box sx={{ display: 'flex', gap: 2, height: '400px' }}>
                <Paper
                  elevation={0}
                  variant="outlined"
                  sx={{ flex: 1, p: 2, overflow: 'auto', bgcolor: '#f8f9fa' }}
                >
                ...
                <Paper
                  elevation={0}
                  variant="outlined"
                  sx={{ flex: 1, p: 2, overflow: 'auto', bgcolor: '#fff' }}
                >
      ...
      {drafts.length > 0 && viewMode === 'diff' && (
        ...
        <Box sx={{ px: 3, py: 1, bgcolor: 'background.default', display: 'flex', gap: 2 }}>
          <Typography variant="caption" color="text.secondary">
            * Comparison view shows the original AI generation on the left and your current edits on
            the right.
          </Typography>
        </Box>
      )}
