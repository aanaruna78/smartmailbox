...
export const BulkDraftDialog: React.FC<BulkDraftDialogProps> = ({ open, onClose, selectedCount, emailIds, onSuccess }) => {
        ...
        <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
            ...
            <DialogContent>
                <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                    Generating drafts for <strong>{selectedCount}</strong> selected emails.
                    They will not be sent automatically. You can review them individually.
                </Typography>
            ...
            <DialogActions>
                ...
                <Button
                    ...
                    startIcon={isSubmitting ? <CircularProgress size={20} color="inherit" /> : <AutoAwesome />}
                >
