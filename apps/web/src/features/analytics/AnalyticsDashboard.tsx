                        ...
                        <Grid container spacing={2}>
                            <Grid item xs={6}>
                                <Card variant="outlined">
                                    <CardContent>
                                        ...
                                        <Typography variant="body2" color="text.secondary">Emails Received</Typography>
                                    </CardContent>
                                </Card>
                            </Grid>
                            <Grid item xs={6}>
                                <Card variant="outlined">
                                    <CardContent>
                                        <Typography variant="h4" color={data.sla.backlog_rate > 30 ? 'error' : 'inherit'}>
                                            {data.sla.backlog}
                                        </Typography>
                            ...
                            <Grid item xs={12}>
                                ...
                                <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
                                    <Chip label={`< 1h: ${data.sla.responses_under_1h}`} color="success" size="small" />
                                    <Chip label={`< 4h: ${data.sla.responses_under_4h}`} color="info" size="small" />
                                    <Chip label={`< 24h: ${data.sla.responses_under_24h}`} color="warning" size="small" />
                                </Box>
                            </Grid>
                        </Grid>
                    </Paper>
                ...
                <Grid item xs={12} md={6}>
                    <Paper sx={{ p: 3 }}>
                        ...
                        <Grid container spacing={2}>
                            <Grid item xs={6}>
                                <Card variant="outlined">
                                    <CardContent>
                                        ...
                                        <Typography variant="body2" color="text.secondary">Drafts Generated</Typography>
                                    </CardContent>
                                </Card>
                            </Grid>
                            <Grid item xs={6}>
                            ...
                            <Grid item xs={12}>
                                <Typography variant="subtitle2" gutterBottom>Acceptance Rate</Typography>
                            ...
                            <Grid item xs={6}>
                                <Typography variant="caption" color="text.secondary">Job Success Rate</Typography>
