                            ...
                            {entries.map((entry) => (
                                <TableRow key={entry.id}>
                                    <TableCell>
                                        <Typography
                                            fontWeight="bold"
                                            color={entry.spam_score >= 60 ? 'error' : entry.spam_score >= 30 ? 'warning.main' : 'success.main'}
                                        >
                                            {entry.spam_score}
                                        </Typography>
                                    </TableCell>
                                    ...
                                    <TableCell align="right">
                                        <Tooltip title="Release">
                                            <IconButton
                                                color="success"
                                                onClick={() => openDialog(entry, 'release')}
                                            >
                                                <CheckCircle />
                                            </IconButton>
                                        </Tooltip>
                                        <Tooltip title="Confirm Spam">
                                            <IconButton
                                                color="error"
                                                onClick={() => openDialog(entry, 'confirm')}
                                            >
                                                <Block />
                                            </IconButton>
                                        </Tooltip>
                ...
                <DialogActions>
                    ...
                    >
                        {processing ? <CircularProgress size={20} /> :
                            dialogType === 'release' ? 'Release' : 'Confirm Spam'
                        }
                    </Button>
                </DialogActions>
            </Dialog>
